...
public class Response implements Serializable {
	...
	public String toString() {
		return "Response [echoCode=" + echoCode + ", user=" + user
				+ ", resFile=" + resFile + ", question=" + question
				+ ", comment=" + comment + ", page=" + page + ", questionList="
				+ questionList + ", commentList=" + commentList
				+ ", resfileList=" + resfileList + ", message=" + message
				+  "]";
	}
